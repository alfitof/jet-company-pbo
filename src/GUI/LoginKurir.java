 ...
 * @author paman
 */
public class LoginKurir extends javax.swing.JFrame {

    /**
     * Creates new form LoginKurir
     */
    public LoginKurir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel8Layout.setVerticalGroup(
            jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(loginAdmin, javax.swing.GroupLayout.Alignment.TRAILING)
        );
    ...
    private void btnLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoginMouseClicked
        ...
        try
        {
            ...
            f=kurir.getLoginKurir(txtusername.getText(), txtpassword.getText());
            if(f==true)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginKurir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
